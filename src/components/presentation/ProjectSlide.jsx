export function ProjectSlide({ 
  ...
  return (
    <div className="relative w-screen h-screen flex items-center justify-center bg-black">
      ...
      {slideNumber && (
        <div className="absolute top-4 right-4 z-10 w-[46px] h-[46px] bg-black/80 border border-white/20 rounded-full text-white text-sm flex items-center justify-center" style={{ fontFamily: 'SuisseIntl', fontWeight: 400 }}>
          {slideNumber}
        </div>
      )}
